...
## Constraints
- Shared contracts from `{{CONTRACTS_PATH}}` are binding. If your design contradicts a contract, the contract wins. To request a contract change, flag it in `AGENT_COMM.md`.
